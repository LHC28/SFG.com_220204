...
<%-- 관리자 페이지 nav --%>
	...
	<section class="adminSection p-3">
		<select id="playerSelectBox" class="mb-2">
			...
			<option data-pitcher-id="${pitcher.id }">${pitcher.name} : ${pitcher.id}</option>
			</c:forEach>
		</select>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#playerSelectBox").on('change', function(){
			playerId = $('#playerSelectBox option:selected').data('pitcher-id');
		...
		$('#jqGrid').jqGrid({
			...
			,colModel: [
				...
				,{label: 'wins', name: 'wins', width: 60, editable: true, editrules: {required: true}, align: "center"}
				,{label: 'losses', name: 'losses', width: 60, editable: true, editrules: {required: true}, align: "center"}
				,{label: 'earned_run_average', name: 'earned_run_average', width: 60, editable: true, editrules: {required: true}, align: "center"}
				,{label: 'games', name: 'games', width: 60, editable: true, editrules: {required: true}, align: "center"}
				,{label: 'game_started', name: 'game_started', width: 60, editable: true, editrules: {required: true}, align: "center"}
				,{label: 'saves', name: 'saves', width: 60, editable: true, editrules: {required: true}, align: "center"}
